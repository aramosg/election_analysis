...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_names:
        ...
        county_results = f"County: {county_name}: {county_vote_percentage:.1f}% ({county_vote_count:,})\n"
        print(county_results) # Printing to console

        # 6e: Save the county votes to a text file.
        txt_file.write(county_results) # Writing to file
